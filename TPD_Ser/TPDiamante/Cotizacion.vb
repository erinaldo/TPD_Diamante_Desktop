...
Public Class Cotizacion
   ...
   Else 'ELSE DE VLIDA SI ES COTIZACION EN DOLAR
    ...
    Try
     ...
     For i = 0 To DGVCap.RowCount - 1
      ...
      ''cmd4.Parameters.AddWithValue("@ListaPrecio", ComboBox1.SelectedValue.ToString())
      ''------------------------------------
      'cmd4.Parameters.AddWithValue("@Consulta", 1)
      ''SOLO SE COLOCA PARA QUE NO MANDE ERROR DE PARAMETROS EN EL PROCEDIMIENTO
      'cmd4.Parameters.AddWithValue("@DescDolar", 0)
      ...
      If DTSinVta.Rows.Count <> 0 Then
       For Each row As DataRow In DTSinVta.Rows
        ...
        DGVCap(4, DGVCap.CurrentRow.Index).Value = row("Discount")
        ...
        Else
         If Decimal.Parse(row("Discount")) <> 0 Then
          PrecioNeto = Decimal.Parse(row("Price")) - ((Decimal.Parse(row("Price")) * Decimal.Parse(row("Discount"))) / 100)
         Else
          PrecioNeto = Decimal.Parse(row("Price"))
         End If
        End If
        DGVCap(5, DGVCap.CurrentRow.Index).Value = PrecioNeto * DGVCap.CurrentRow.Cells(0).Value
       Next
 ...
 Private Sub DGVCap_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles DGVCap.CellValueChanged
  ...
  If DGVCap.Rows.Count > 0 Then
   ...
   Dim lISTA = CStr(row.Cells(8).Value)
    ...
    If DGVCap.Rows.Count > 0 Then
     ...
     If e.ColumnIndex = 0 Or e.ColumnIndex = 8 Then
      ...
      Try
       ...
       ''SE COMENTO PARA PRUEBAS PARA EL NUEVO PROCEDIMIENTO 
       ''
       '--------------------------------------------
       'If DTSinVta.Rows.Count > 0 Then

...
Public Class CR_Paking_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.CR_Paking_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Paking_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Paking_List = New CR_Paking_List()
        rpt.Site = Me.Site
        Return rpt
    End Function

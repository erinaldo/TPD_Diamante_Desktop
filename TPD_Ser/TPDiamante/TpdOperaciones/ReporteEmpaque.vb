...
Public Class ReporteEmpaque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.ReporteEmpaque.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_empaco() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteEmpaque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEmpaque = New ReporteEmpaque()
        rpt.Site = Me.Site
        Return rpt
    End Function

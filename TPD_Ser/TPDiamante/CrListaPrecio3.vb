...
Public Class CrListaPrecio3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.CrListaPrecio3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrListaPrecio3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrListaPrecio3 = New CrListaPrecio3()
        rpt.Site = Me.Site
        Return rpt
    End Function

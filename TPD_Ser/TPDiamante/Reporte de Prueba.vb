...
Public Class Reporte_de_Prueba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.Reporte de Prueba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_de_Prueba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_de_Prueba = New Reporte_de_Prueba()
        rpt.Site = Me.Site
        Return rpt
    End Function

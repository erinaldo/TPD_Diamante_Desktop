...
Public Class Garantias
        ...
        If TBDocNum.Text <> "" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    cmd4 = New SqlCommand("DetalleGarantias", conexion2)
    ...
    Private Sub FacturaConsulta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Me.DGDetalle.Columns(e.ColumnIndex).Name = "detalle" And DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value > 0
    ...
    Private Sub DGDetalle_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DGDetalle.CellEndEdit
        If Me.DGDetalle.Columns(e.ColumnIndex).Name = "CantidadGar" Then
            ...
            conexion2.Open()
            Dim cmd As SqlCommand = New SqlCommand("SELECT CASE WHEN CANTIDAD IS NULL THEN 0 ELSE CANTIDAD END AS 'Cantidad' FROM TPM.DBO.FactGar WHERE Factura=@Factura AND Itemcode=@Itemcode ", conexion2)
            ...
            If DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value + Aux > DGDetalle.Item(6, DGDetalle.CurrentRow.Index).Value Then
                MessageBox.Show("Número de garantías sobrepasa el total de Artículos.", _
                                               "Advertencia", _
            ...
            ElseIf DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value > 0 And DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value <= DGDetalle.Item(6, DGDetalle.CurrentRow.Index).Value Then
                ...
                If (MessageBox.Show("¿Confirma que desea agregar " & cant & " garantía(s) del artículo " & art & "?", _
                                   "Advertencia", _
                    ...
                    Try
                        ...
                        Try
                            ...
                            cmd4 = New SqlCommand("SPActualizaCantidadDetFactGar", cnn)
                            cmd4.CommandType = CommandType.StoredProcedure
                        ...
                        conexion2.Open()
                        Dim cmd3 As SqlCommand = New SqlCommand("SELECT case when MAX(Id) IS NULL then 0 else max(id) end as 'id' FROM TPM.DBO.DetFactGar WHERE Factura=@Factura AND Itemcode=@Itemcode ", conexion2)
                        ...
                        Try
                            ...
                            cmd2 = New SqlCommand("SPGuardaDetFactGar2", cnn2)
    ...
    Private Sub AgregaArticulo()
        ...
        Try
            ...
            If DGDetalle.RowCount > 0 Then
                If DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value <> 0 Or _
                    ...
                    Try
                        ...
                        cmd4 = New SqlCommand("SPGuardaFactGar", cnn)
                        cmd4.CommandType = CommandType.StoredProcedure
                        cmd4.Parameters.AddWithValue("@Factura", TBDocNum.Text)
                    ...
                    Module1.FecFact = TBDocDate.Text
                    Module1.CodCliente = TBCliente.Text
                    Module1.NomCliente = TBNomCli.Text
                    Module1.GarAlm = DGDetalle.Item(5, DGDetalle.CurrentRow.Index).Value
                    Module1.Articulo = DGDetalle.Item(0, DGDetalle.CurrentRow.Index).Value
                    Module1.Descripcion = DGDetalle.Item(1, DGDetalle.CurrentRow.Index).Value
                    Module1.Linea = DGDetalle.Item(2, DGDetalle.CurrentRow.Index).Value
                    Module1.Proveedor = DGDetalle.Item(3, DGDetalle.CurrentRow.Index).Value
                    Module1.CantidadGar = 1
                    ...
                    For i As Integer = 1 To Module1.CantidadGar
                        ...
                        Try
                            ...
                            'cmd2.Parameters.AddWithValue("@FecAlm", "20150101")
                            cmd2.Parameters.AddWithValue("@Folio", "")
                            cmd2.Parameters.AddWithValue("@Factura", Module1.Factura)
                            cmd2.Parameters.AddWithValue("@FecFac", Fechafact)
                            cmd2.Parameters.AddWithValue("@CardCode", Module1.CodCliente)
                            cmd2.Parameters.AddWithValue("@CardName", Module1.NomCliente)
                            cmd2.Parameters.AddWithValue("@Sucursal", "")
                            cmd2.Parameters.AddWithValue("@Almacen", Module1.GarAlm)
                            cmd2.Parameters.AddWithValue("@Cantidad", 1)
                            cmd2.Parameters.AddWithValue("@Itemcode", Module1.Articulo)
                            cmd2.Parameters.AddWithValue("@ItemName", Module1.Descripcion)
                            cmd2.Parameters.AddWithValue("@ItmsGrpNam", Module1.Linea)
                            cmd2.Parameters.AddWithValue("@Proveedor", Module1.Proveedor)
                            cmd2.Parameters.AddWithValue("@Causa", "")
                            'cmd2.Parameters.AddWithValue("@FecEntcompRec", "20150101")
                            'cmd2.Parameters.AddWithValue("@FecEntProvRev", "20150101")
                            cmd2.Parameters.AddWithValue("@Seguimiento", "")
            ...
            If DGDetalle.RowCount > 0 Then
                If DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value <> 0 Or _
                    ...
                    Try
                        ...
                        cmd4 = New SqlCommand("SPActualizaDetFactGar", cnn)
                        cmd4.CommandType = CommandType.StoredProcedure
                        cmd4.Parameters.AddWithValue("@Factura", TBDocNum.Text)
                        cmd4.Parameters.AddWithValue("@Fecha", Fechafact)
                        cmd4.Parameters.AddWithValue("@Itemcode", DGDetalle.Item(0, DGDetalle.CurrentRow.Index).Value)
                    ...
                    Module1.Linea = DGDetalle.Item(2, DGDetalle.CurrentRow.Index).Value
                    Module1.Proveedor = DGDetalle.Item(3, DGDetalle.CurrentRow.Index).Value
                    Module1.CantidadGar = DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value
                    ...
                    Try
                        ...
                        'cmd2.Parameters.AddWithValue("@FecDoc", "20150101")
                        'cmd2.Parameters.AddWithValue("@FecEntAl", "20150101")
                        cmd2.Parameters.AddWithValue("@Id", Module1.CantidadGar)
            ...
            If Me.DGDetalle.Columns(e.ColumnIndex).Name = "Agregar" Then
                ...
                Try
                    ...
                    If String.IsNullOrEmpty(DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value) Then
                        ...
                        If (MessageBox.Show("¿Confirma que desea agregar 1 garantía del artículo " & DGDetalle.Item(0, DGDetalle.CurrentRow.Index).Value & "?", _
                                               "Advertencia", _
                                               MessageBoxButtons.YesNo, _
                                              MessageBoxIcon.Exclamation)) = MsgBoxResult.Yes Then
                            DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value = 1
                    ...
                    ElseIf DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value > 0 And DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value < DGDetalle.Item(6, DGDetalle.CurrentRow.Index).Value Then
                        ...
                        If (MessageBox.Show("¿Confirma que desea agregar 1 garantía del artículo " & art & "?", _
                                           "Advertencia", _
                                           MessageBoxButtons.YesNo, _
                                          MessageBoxIcon.Exclamation)) = MsgBoxResult.Yes Then
                    ...
                    ElseIf cant > DGDetalle.Item(6, DGDetalle.CurrentRow.Index).Value Then
                        MessageBox.Show("Ingrese valor válido, número de garantías mayor a cantidad de artículos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Return
                    End If
    ...
    'Private Sub DGDetalle_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DGDetalle.CellMouseClick
    '    Try
    '        If String.IsNullOrEmpty(DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value) Then
    '            DGDetalle.Columns(19).ReadOnly = False
    '        ElseIf Me.DGDetalle.Columns(e.ColumnIndex).Name = "CantidadGar" And DGDetalle.Item(19, DGDetalle.CurrentRow.Index).Value > 0 Then
    '            DGDetalle.Columns(19).ReadOnly = True
    '        Else
    '            DGDetalle.Columns(19).ReadOnly = False
    '        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Module1.Factura = String.Empty
        Module1.Articulo = String.Empty

...
Public Class CRSolVacaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.CRSolVacaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ParametroNombre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRSolVacaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSolVacaciones = New CRSolVacaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function

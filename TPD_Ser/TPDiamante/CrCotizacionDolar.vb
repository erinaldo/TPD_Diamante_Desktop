...
Public Class CrCotizacionDolar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.CrCotizacionDolar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrCotizacionDolar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCotizacionDolar = New CrCotizacionDolar()
        rpt.Site = Me.Site
        Return rpt
    End Function

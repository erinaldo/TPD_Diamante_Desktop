...
Public Class LineasHalconDetalle
  ...
  Private bEdit As Boolean
    ...
    Private Sub Form1_Load( _
        ...
        Try
            ...
            cmd4 = New SqlCommand("SPLineasHalconDetalle", cnn)
            ...
            cmd4.Parameters.Add("@Agente", SqlDbType.NVarChar, 100).Value = LineasHalcon.DgVtaAgte.Item(0, LineasHalcon.DgVtaAgte.CurrentCell.RowIndex).Value


            Label1.Text = LineasHalcon.DgVtaAgte.Item(0, LineasHalcon.DgVtaAgte.CurrentCell.RowIndex).Value

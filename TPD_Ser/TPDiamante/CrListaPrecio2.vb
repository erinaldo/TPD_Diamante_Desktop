...
Public Class CrListaPrecio2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPDiamante.CrListaPrecio2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NumLista() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrListaPrecio2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrListaPrecio2 = New CrListaPrecio2()
        rpt.Site = Me.Site
        Return rpt
    End Function

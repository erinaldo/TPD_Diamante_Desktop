...
Public Class LODetalleTotales
    ...
    Private Sub LineasObjetivoDetalle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            mes2 = LOIngObj.DGLOIngGen.Item(0, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value
            anio2 = LOIngObj.DGLOIngGen.Item(1, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value
            ...
            cmd.Parameters.AddWithValue("@mes", mes2)
            cmd.Parameters.AddWithValue("@anio", anio2)


            Label1.Text = "Detalle de lineas del Mes: " & LOIngObj.DGLOIngGen.Item(0, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value & " Año: " & LOIngObj.DGLOIngGen.Item(1, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value
        ...
        Dim mes As Integer
        Dim anio As Integer
            mes = LOIngObj.DGLOIngGen.Item(0, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value
            anio = LOIngObj.DGLOIngGen.Item(1, LOIngObj.DGLOIngGen.CurrentCell.RowIndex).Value

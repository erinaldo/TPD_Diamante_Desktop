...
Public Class DetGarantias
    ...
    '    MsgBox(Date.Parse("01-01-2016").Date.ToString("yyyyMMdd"))
    '    MsgBox(Date.Parse("01-01-2016").Date.ToString("yyyyMMdd"))
    '    MsgBox(Date.Parse("01-01-2016").Date.ToString("yyyyMMdd"))
    '    MsgBox(Date.Parse("01-01-2016").Date.ToString("yyyyMMdd"))
    'End Sub
    ...
    Private Sub Button2_Click_2(sender As Object, e As EventArgs) Handles Button2.Click
        'DGGarantias.Columns.RemoveAt(0)
        '0DGGarantias.DataSource = ""
        'Dim n As Integer
        'n = DGGarantias.Rows.Count
        'Dim i As Integer

        'For i = 0 To n
        '    'DGGarantias.Rows(i).Clear()
        'Next


        'DGGarantias.DataSource = String.Empty
        ''CONSULTAR 
    ...
    '    MsgBox(DGGarantias.Item(DGGarantias.CurrentCell.ColumnIndex, DGGarantias.CurrentRow.Index).Value)
    '    Try
    '        MsgBox(Date.Parse(DGGarantias.Item(1, DGGarantias.CurrentRow.Index).Value).Date.ToString("yyyyMMdd"))  'DGGarantias.Item(3, DGGarantias.CurrentRow.Index).Value
